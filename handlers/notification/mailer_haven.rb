...
class Mailer < Sensu::Handler
  ...
  def handle
    smtp_address = settings['mailer_haven']['smtp_address'] || 'localhost'
    smtp_port = settings['mailer_haven']['smtp_port'] || '25'
    smtp_domain = settings['mailer_haven']['smtp_domain'] || 'localhost.localdomain'

    params = {
      :mail_to   => settings['mailer_haven']['mail_to'],
      :mail_from => settings['mailer_haven']['mail_from'],
